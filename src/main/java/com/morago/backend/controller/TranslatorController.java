...
@Tag(
        name = "Translators",
        description = "Translator profiles and lookups. Access: [USER, ADMIN] (browse/lookups), [ADMIN] (full list, by id except self), [USER, TRANSLATOR, ADMIN] (update my profile)"
)
